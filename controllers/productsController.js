const { getAllProducts, getUniqueProduct } = require('../models/productsModel')
const { getProductByCategory,checkProductExists,createProduct } = require('../models/productsModel')
